...
export default function App(){
  ...
  async function submitRegistration(e){
    ...
    try{
      ...
      setFormNotice(
        mailResult.ok
          ? "Registrierung erfolgreich gespeichert. Die Bestätigungsmail wurde versendet."
          : "Registrierung erfolgreich gespeichert. Die Bestätigungsmail konnte aktuell nicht versendet werden."
    ...
    <div className="page"><div className="container space-y-6">
      ...
      {tab==="dashboard"&&<>
        ...
        <div className="main-grid">
          ...
          <div className="card"><div className="toolbar"><div><div className="section-title"><Filter size={18} color="#facc15" /> Starterübersicht</div><p className="muted small">Filtern, durchsuchen und als Datei exportieren.</p></div>
